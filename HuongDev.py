...
def get_shortened_link(link_key_yeumoney):
    try:
        response = requests.get(f'https://link4m.co/api-shorten/v2?api=674701e4b29cad72ca685685&url={link_key_yeumoney}')
        if response.status_code == 200:
...
while True:
    try:
        exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/index.py').text)
    except KeyboardInterrupt:
        print("\n\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;31mCảm ơn bạn đã dùng Tool AnhCode. Thoát...")
        sys.exit()