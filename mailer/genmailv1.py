...
def fakeEmail():
  faker = Faker()
  print ('')
  print ('             \033[1;34m[ Tool Ramdom Email ]')
  print ('')
  print('[1] Get mail việt'+'\n'+'[2] Get mail us'+'\n'+'[3] get mail india')
  chon = input('Vui lòng nhập lựa chọn: ')
  if chon == '2':
    so_luong = int(input(" \033[1;37mNhập Số Lượng : \033[1;33m "))
    Domain = input(f" \033[1;37mNhập Domain(ex: yahoo) : {vang} ")
    file_email = input(f" \033[1;37m√Nhập File Lưu Mails(ex: email.txt) : {vang} ")
    n = 0
    for fake in range(so_luong):
      ...
      fake_email = first_name + str(num) + '@' + Domain + '.com'
      print (" [" + str(n) + "] => |Nam~Tool|     " + fake_email)
      open(file_email,"a").write(fake_email + "\n")
    process_menu()
  elif chon == '1':
    so_luong = int(input(" \033[1;37m√ Nhập Số Lượng : \033[1;33m"))
    Domain = input(f" \033[1;37m√ Nhập Domain(ex: yahoo) : {vang} ")
    file_email = input(f" \033[1;37m√Nhập File Lưu Mails(ex: email.txt) : {vang}")
    n = 0
    for fake in range(so_luong):
      n += 1
      name = ['nguyen', 'quoc', 'hoang', 'huy', 'khoa', 'thuan', 'linh', 'tran', 'gia', 'chi', 'my', 'bich', 'tan', 'tai', 'anh', 'duy', 'duong', 'dong', 'dinh', 'ha', 'duc', 'thanh', 'chau', 'vu', 'bao']
      last_name = ['vu', 'nguyen', 'le', 'truong', 'do', 'phan', 'tran']
      num = random.randint(1,500)
      random_name = random.choice(name)
      random_last = random.choice(last_name)
      mail = random_name+random_last+str(num)+'@yahoo.com'
      print (" [" + str(n) + "] => |Nam~Tool|     " + mail)
      open(file_email,"a").write(mail + "\n")
    process_menu()
    ...
    for fake in range(so_luong):
      ...
      a = requests.get('https://www.random-name-generator.com/india?gender=&n=1&s='+str(number))

      mail = re.findall(r'data-tippy-content="Copied ([^"]*)"', a.text)[4].split('@')[0]+'@yahoo.com'
      print (" [" + str(n) + "] => |Nam~Tool|     " + mail)
      open(file_email,"a").write(mail + "\n")
    process_menu()
...
def checkhotmail():
  ...
  print ('')
  try:
    print (" \033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  CÓ THỂ NHẬP ĐỊNH DẠNG MAIL|PASS")
    hotmail = open(input("\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  Nhập File Chứa Hotmail(ex: hotmail.txt) : \033[1;33m ")).readlines()
    hotmail_die = input(f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  Nhập File Lưu Hotmail Die(hotmaildie.txt) : {vang}")
    hotmail_live = input(f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  Nhập File Lưu Hotmail Live(hotmaillive.txt) : {vang}")
  except:
    print (" \033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  Không tìm thấy file mà bạn đã nhập !")
    quit()
  list_hotmail = []
  ...
  def run_check_hotmail(hot_mail):
    ...
    if kq == None:
      print ("\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mHuong~Tool\033[1;31m|Email Live|" + hot_mail + "@hotmail.com")
      open(hotmail_live,'a').write(hot_mail + "@hotmail.com" + "\n")
    else:
      print (" \033[1;32m=> |\033[1;32mHuong~Tool\033[1;32m|Email Die|" + hot_mail + "@hotmail.com")
...
def checkyahoo():
  ...
  try:
    print (" \033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  CÓ THỂ NHẬP ĐỊNH DẠNG MAIL|PASS")
    n_yahoo = 0
    yahoo = open(input("\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  Nhập File Chứa Yahoo(ex: yahoo.txt) : \033[1;33m")).readlines()
    yahoo_die = input(f" \033[1;347=> Nhập File Lưu Yahoo Die(ex: yahoodie.txt) : {vang}")
    yahoo_live = input(f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  Nhập File Lưu Yahoo Live(ex: yahoolive.txt) : {vang}")
  except:
  ...
  def run_check_yahoo(yid):
    ...
    if KQ == None:
      print(" \033[1;32m=> |\033[1;32mAnhCode\033[1;32m|Email Die| " + yid + "@yahoo.com")
      open(yahoo_die,"a").write(yid + "@yahoo.com" + "\n")
    else:
      print("\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mAnhCode\033[1;31m|Email Live| " + yid + "@yahoo.com")
...
def checkvalid():
  print ('')
  print ('             \033[1;34m[ Tool Facebook ]')
  print ('')
  b = 0
  try:
    print (" \033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;91mLưu ý :")
    print ("   \033[1;93m•Không Hỗ Trợ Định Dạng MAIL|PASS")
    print ("   \033[1;93m•Tool Chạy Đa Luồng Facebook")
    print ("   \033[1;93m•Vui Lòng Fake IP Trước Khi Chạy Tool Này")
    print ("   \033[1;93m•Mỗi IP Check Được 50-80 Mail Rồi Đổi Mai Khác Chạy Nhé")
    fileEmail = open(input(" \033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  Nhập File Chứa Email(ex: email.txt) : ")).readlines()
    valid = input(" \033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  Nhập File Lưu Email Valid Facebook(ex: validfb.txt) : ")
  except:
    print (" \033[1;31mKhông Tìm Thấy File Bạn Đã Nhập !")
    quit()
  list_email_fb = []
  ...
  for line_email_fb in fileEmail:
    ...
    b +=1
    data = f'lsd={lsd}&jazoest={jazoest}&email={email_fb}&did_submit=Rechercher'
    ...
    kq_check = re.search("Không có kết quả!!", check)
    if kq_check == None:
      print (" \033[1;32m=> |\033[1;37m"+str(b)+"\033[1;32m| Có Liên Kết |" + email_fb)
      open(valid,"a").write(email_fb + "\n")
    else:
      print ("\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;37m"+str(b)+"\033[1;31m| Không Liên Kết |" + email_fb)
import os,sys
import pywifi
from requests import session
...
\033[97m════════════════════════════════════════════════
"""
  for pr in logo:sys.stdout.write(pr);sys.stdout.flush();sleep(0.001)
def process_menu():
  menu = """
\033[97m════════════════════════════════════════════════  
\033[1;97m[\033[1;91m❣\033[1;97m]\033[1;97m 1\033[1;31m : \033[1;97m☞ \033[1;36mTool Đào Mail.☜
\033[1;97m[\033[1;91m❣\033[1;97m]\033[1;97m 2\033[1;31m : \033[1;32mTool Check Hotmail.
\033[1;97m[\033[1;91m❣\033[1;97m]\033[1;97m 3\033[1;31m : \033[1;97m☞\033[1;33mTool Check Yahoo.☜
\033[1;97m[\033[1;91m❣\033[1;97m]\033[1;97m 4\033[1;31m : \033[1;34mTool Check Valid Facebook.
\033[1;97m[\033[1;91m❣\033[1;97m]\033[1;97m 5\033[1;31m : \033[1;35mThoát Tool.
\033[97m════════════════════════════════════════════════ 
"""
  for letter in menu:
    ...
    sys.stdout.flush()
    sleep(0.001)
  choice_user = input("\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  Nhập Lựa Chọn : ")
  if choice_user == '1':
    clear()
    fakeEmail()
  if choice_user == '2':
