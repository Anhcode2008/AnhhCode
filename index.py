...
while True:
	...
	if chon == '1':
		# Thành Công
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/Full%20Golike/AutoTikTok.py').text)
	elif chon == '1.1':
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/Full%20Golike/AutoTikTokv1.py').text)
	elif chon == '1.2':
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/Full%20Golike/AutoTikTokv2.py').text)
	elif chon == '1.3':
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/Full%20Golike/AutoIG.py').text)
	elif chon == '1.4':
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/Full%20Golike/AutoX.py').text)
	elif chon == '1.5':
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/Full%20Golike/AutoYTB.py').text)
	elif chon == '1.6':
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/Full%20Golike/AutoTheads.py').text)
	elif chon == '1.7':
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/Full%20Golike/AutoLinkedin.py').text)
	elif chon == '1.8':
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/Full%20Golike/AutoLinkedin.py').text)
        
		# TTC
	elif chon == '2.1':
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/TuongTacCheo/TTCFB.py').text)
	elif chon == '2.2':
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/TuongTacCheo/TTCPro5.py').text)
	elif chon == '2.3':
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/TuongTacCheo/TTCPro5v1.py').text)
	elif chon == '2.4':
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/TuongTacCheo/TTCTikTok.py').text)
	elif chon == '2.5':
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/TuongTacCheo/TTCIG.py').text)
		# TDS
	elif chon == '3.1':
		# Thanh Công
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/TraoDoiSub/ToolTDSFb.py').text)
	elif chon == '3.2':
		# Thanh Công
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/TraoDoiSub/ToolTDSPro5.py').text)
	elif chon == '3.3':
		# Thanh Công
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/TraoDoiSub/ToolTDSPro5v1.py').text)
	elif chon == '3.4':
		# Thanh Công
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/TraoDoiSub/ToolTDSTikTok.py').text)
	elif chon == '3.5':
		# Thanh Công
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/TraoDoiSub/TDSIG.py').text)
	elif chon == '3.6':
		# Thanh Công
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/TraoDoiSub/TDSIG.py').text)	
		# Buff view
		...
		# Thanh Công
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/mailer/genmailv2.py').text)
	elif chon == '5.3':
		# Thanh Công
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/proxy/genproxyv1.py').text)
	elif chon == '5.4':
		# Thanh Công
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/proxy/genproxyv2.py').text)
	elif chon == '5.5':
		# Thanh Công
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/proxy/genproxyv3.py').text)
	elif chon == '5.6':
		# Thanh Công
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/proxy/genproxyv4.py').text) 
	elif chon == '6.1':
		# Thanh Công
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/KeyVip.py').text)
	elif chon == '6.2':
		# Thanh Công
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/KeyVip.py').text)
	elif chon == '6.3':
		# Thanh Công
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/spam/spammess.py').text)
	elif chon == '6.4':
		# Thanh Công
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/spam/spamsms.py').text)
	elif chon == '7.1':
		# Thanh Công
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/KeoAirdrop/ToolBlum.py').text)
	elif chon == '7.2':
		# Thanh Công
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/KeoAirdrop/ToolBlum.py').text)
	elif chon == '7.3':
		...
		# Thanh Công
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/TienIchFaceBook/ToolGetidFacebook.py').text)
	elif chon == '8.2':
		# Thanh Công
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/TienIchFaceBook/ToolGetTokenFB.py').text)
	elif chon == '8.3':
		# Thanh Công
		...
		# Thanh Công
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/TienIchFaceBook/vidtiktok.py').text) 
	elif chon == '8.7':
		# Thanh Công
		exec(requests.get('https://raw.githubusercontent.com/Anhcode2008/AnhhCode/refs/heads/main/TienIchFaceBook/vidytb.py').text)
	elif chon == '8.8':
		# Thanh Công
