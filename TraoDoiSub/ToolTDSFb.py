...
def error(id, type):
	time=datetime.now().strftime("%H:%M:%S")
	uid = id.split('_')[1] if '_' in id else id
	print(f'\033[1;31m Đang Xảy Ra Lỗi Gì Đó Thông Cảm Nhé!!', end = '\r'); sleep(2); print('                                                   ', end = '\r')
...
def Nhap_Cookie():
	...
	while True:
		i += 1
		cookie = input(f'\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;31mNhập Cookie Facebook Thứ: \033[1;33m{i}: ')
		if cookie == '' and i > 1:
			break
		...
		if name != 0:
			ten = name[0]
			print('\033[1;31m────────────────────────────────────────────────────────────')
			print(f'\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;33mTên Facebook: {ten}')
...
def main():
	...
	while True:
		if os.path.exists('configtds.txt'):
			...
			data = tds.main()
			try:
				print('\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mNhập [\033[1;33m1\033[1;33m] \033[1;32mGiữ Lại Tài Khoản '+ data['user'] )
				print('\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mNhập [\033[1;33m2\033[1;33m] \033[1;32mNhập Access_Token TDS Mới')
				chon = input('\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mNhập \033[1;31m✈  :\033[1;33m ')
				if chon == '2':
		...
		if not os.path.exists('configtds.txt'):
			token = input('\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mNhập Access_Token TDS:\033[1;33m ')
	...
	while True:
		if os.path.exists('Cookie_FB.txt'):
			print('\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mNhập [\033[1;33m1\033[1;33m] \033[1;32mSử Dụng Cookie Facebook Đã Lưu ')
			print('\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mNhập [\033[1;33m2\033[1;33m] \033[1;32mNhập Cookie Facebook Mới')
			chon = input('\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mVui Lòng Nhập:\033[1;33m ')
			if chon == '1':
	...
	print(f'\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mXu Hiện Tại: \033[1;33m{xu}')
	print(f'\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mXu Bị Phạt: \033[1;33m{xudie} ')
	print(f'\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mSố Cookie: {len(list_cookie)} ')
	print('\033[1;31m────────────────────────────────────────────────────────────')
	print('\033[1;33m[1 : LIKE — 2 : COMMENT — 3 : SHARE — 4 : REACTION]')
	print('\033[1;33m[5 : FOLLOW — 6 : PAGE — 7 : REACTCMT —  8 : GROUP]')
	print('\033[1;31m────────────────────────────────────────────────────────────')
	print('\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;36mCó Thể Chọn Nhiều Nhiệm Vụ (Ví Dụ 123...)')
	nhiemvu = input ('\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mNhập Số Để Chạy Nhiệm Vụ: ')
	delaymin = int(input('\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mNhập Delay Min: '))
	delaymax = int(input('\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mNhập Delay Max: '))
	print('\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mSau ____ Nhiệm Vụ Thì Kích Hoạt Chống Block.',end='\r')
	nvblock = int(input('\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mSau '))
	print(f'\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mSau {nvblock} Nhiệm Vụ Nghỉ Ngơi ____ Giây       ',end='\r')
	delaybl = int(input(f'\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mSau {nvblock} Nhiệm Vụ Nghỉ Ngơi '))
	doinick = int(input('\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mSau Bao Nhiêu Nhiệm Vụ Thì Đổi Nick: '))
	print('\033[1;31m────────────────────────────────────────────────────────────')
	while True:
		...
		for cookie in list_cookie:
			...
			if name != 0:
				...
				print(f'\033[1;31mCookie Tài Khoản {id} Die', end='\r');sleep(3); print('                                     ', end = '\r' )
			...
			######
				...
				if nvlike == 1:
					...
					if listlike == False:
						print('\033[1;31mKhông Get Được Nhiệm Vụ Like              ', end = '\r');sleep(2); print('                                                        ', end = '\r')
						nvlike = 0
						...
						if len(listlike) == 0:
							print('\033[1;31mHết Nhiệm Vụ Like                             ', end = '\r');sleep(2); print('                                                        ', end = '\r')
							nvlike = 0
						else:
							...
							for x in listlike:
								...
								if like == False:
									...
									try:
										...
										loilike = 0
										if dem % doinick == 0:
											namtool(14); print(f'\033[1;32mSố Xu Hiện Tại: \033[1;33m{xu} \033[1;31m| \033[1;32mSố Tài Khoản Facebook \033[1;33m{len(list_cookie)}'); namtool(14); ntool = 1; break
										if dem % nvblock == 0:
											chongblock(delaybl)
										else:
				...
				if nvlike2 == 1:
					...
					if listlike2 == False:
						print('\033[1;31mKhông Get Được Nhiệm Vụ Like 2                        ', end = '\r');sleep(2); print('                                                        ', end = '\r')
						nvlike2 = 0
						...
						if len(listlike2) == 0:
							print('\033[1;31mHết Nhiệm Vụ Like 2                                  ', end = '\r');sleep(2); print('                                                        ', end = '\r')
							nvlike2 = 0
						else:
				...
				if nvlike3 == 1:
					...
					if listlike3 == False:
						...
						if listlike3.json()['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
							...
							print(f'\033[1;31mĐang Get Nhiệm Vụ Like 3, COUNTDOWN: {str(round(coun, 3))}                 ', end = '\r'); sleep(2); print('                                                       ', end = '\r')
						else:
				...
				if nvcmt == 1:
					...
					if listcmt == False:
						print('\033[1;31mKhông Get Được Nhiệm Vụ Comment                     ', end = '\r');sleep(2); print('                                                        ', end = '\r')
						nvcmt = 0
					elif 'error' in listcmt.text:
						if listcmt.json()['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
							coun = listcmt.json()['countdown']
							print(f'\033[1;31mĐang Get Nhiệm Vụ Comment, COUNTDOWN: {str(round(coun, 3))}               ', end = '\r'); sleep(2); print('                                                       ', end = '\r')
						else:
							...
							for x in listcmt:
								...
								if loicmt >= 5:
									...
									if name == 0:
										...
										print(f' \033[1;31mTài Khoản {ten} Đã Bị Block Comment !!!					')
									list_cookie.remove(cookie)
									ntool = 1
									break
				...
				if nvshare == 1:
					...
					if listshare == False:
						print('\033[1;31mKhông Get Được Nhiệm Vụ Share                       ', end = '\r');sleep(2); print('                                                        ', end = '\r')
						nvshare = 0
					elif 'error' in listshare.text:
						if listshare.json()['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
							coun = listshare.json()['countdown']
							print(f'\033[1;31mĐang Get Nhiệm Vụ Share, COUNTDOWN: {str(round(coun, 3))}                ', end = '\r'); sleep(2); print('                                                       ', end = '\r')
						else:
						...
						if len(listshare) == 0:
							print('\033[1;31mHết Nhiệm Vụ Share ', end = '\r');sleep(2); print('                                                        ', end = '\r')
							nvshare = 0
						else:
							...
							for x in listshare:
								...
								if loishare >= 5:
									...
									if name == 0:
										...
										print(f' \033[1;31mTài Khoản {ten} Đã Bị Block Share !!!					')
									list_cookie.remove(cookie)
									ntool = 1
									break
				...
				if nvcx == 1:
					...
					if listcx == False:
						print('\033[1;31mKhông Get Được Nhiệm Vụ Cảm Xúc                             ', end = '\r');sleep(2); print('                                                        ', end = '\r')
						nvcx = 0
				...
				if nvfollow == 1:
					...
					if listfollow == False:
						print('\033[1;31mKhông Get Được Nhiệm Vụ Follow                      ', end = '\r');sleep(2); print('                                                        ', end = '\r')
						nvfollow = 0
						listfollow = []
					elif 'error' in listfollow.text:
						if listfollow.json()['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
							coun = listfollow.json()['countdown']
							print(f'\033[1;31mĐang Get Nhiệm Vụ Follow, COUNTDOWN: {str(round(coun, 3))}                     ', end = '\r'); sleep(2); print('                                                       ', end = '\r')
						else:
							...
							for x in listfollow:
								...
								if loifollow >= 5:
									...
									if name == 0:
										...
										print(f' \033[1;31mTài Khoản {ten} Đã Bị Block Follow !!!					')
									list_cookie.remove(cookie)
									ntool = 1
									break
				...
				if nvpage == 1:
					...
					if listpage == False:
						print('\033[1;31mKhông Get Được Nhiệm Vụ Like Page                 ', end = '\r');sleep(2); print('                                                        ', end = '\r')
						nvpage = 0
						listpage = []
					elif 'error' in listpage.text:
						if listpage.json()['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
							coun = listpage.json()['countdown']
							print(f'\033[1;31mĐang Get Nhiệm Vụ Page, COUNTDOWN: {str(round(coun, 3))}                         ', end = '\r'); sleep(2); print('                                                       ', end = '\r')
						else:
							...
							for x in listpage:
								...
								if loipage >= 5:
									...
									if name == 0:
										...
										print(f' \033[1;31mTài Khoản {ten} Đã Bị Block Like Page !!!					')
									list_cookie.remove(cookie)
									ntool = 1
									break
				if ntool == 1:
				...
				if nvcxcmt == 1:
					...
					if listcxcmt == False:
						print('\033[1;31mKhông Get Được Nhiệm Vụ Cảm Xúc Comment ', end = '\r');sleep(2); print('                                                        ', end = '\r')
						nvcxcmt = 0
						listcxcmt = []
					elif 'error' in listcxcmt.text:
						if listcxcmt.json()['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
							coun = listcxcmt.json()['countdown']
							print(f'\033[1;31mĐang Get Nhiệm Vụ Cảm Xúc Comment, COUNTDOWN: {str(round(coun, 3))}                   ', end = '\r'); sleep(2); print('                                                       ', end = '\r')
						else:
						...
						if len(listcxcmt) == 0:
							print('\033[1;31mHết Nhiệm Vụ Cảm Xúc Comment                       ', end = '\r');sleep(2); print('                                                        ', end = '\r')
							listcxcmt = 0
						else:
							...
							for x in listcxcmt:
								...
								if loicxcmt >= 5:
									...
									if name == 0:
										...
										print(f' \033[1;31mTài Khoản {ten} Đã Bị Block Cảm Xúc CMT !!!					')
									list_cookie.remove(cookie)
									ntool = 1
									break
				if ntool == 1:
				...
				if nvgroup == 1:
					...
					if listgroup == False:
						print('\033[1;31mKhông Get Được Nhiệm Vụ Group                               ', end = '\r');sleep(2); print('                                                        ', end = '\r')
						nvgroup = 0
						listgroup = []
					elif 'error' in listgroup.text:
						if listgroup.json()['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
							coun = listgroup.json()['countdown']
							print(f'\033[1;31mĐang Get Nhiệm Vụ Group, COUNTDOWN: {str(round(coun, 3))}               ', end = '\r'); sleep(2); print('                                                       ', end = '\r')
						else:
							print(listlike.json()['error'] , end ='\r')
						nvgroup = 0
						listgroup = []
						...
						if len(listgroup) == 0:
							print('\033[1;31mHết Nhiệm Vụ Group                                 ', end = '\r');sleep(2); print('                                                        ', end = '\r')
							listgroup = 0
						else:
							...
							for x in listgroup:
								...
								if loigroup >= 5:
									...
									if name == 0:
										...
										print(f' \033[1;31mTài Khoản {ten} Đã Bị Block Join Group !!!					')
									list_cookie.remove(cookie)
									ntool = 1
									break
				if ntool == 1:
				...
				if nvcx + nvgroup + nvcxcmt + nvpage + nvfollow + nvshare + nvcmt + nvlike == 0:
					for i in range(10, 0, -1):
						print(f' \033[1;31mTất Cả Các Nhiệm Vụ Đã Hết, Vui Lòng Chờ {i} Giây ', end = '\r');sleep(1); print('                                                        ', end = '\r')
